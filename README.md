...
I am aware that Open AI's GPT3 performs better than BERT at text classification, but due t sto limited access I decided to use BERT for this classification project. 
